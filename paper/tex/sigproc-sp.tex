...
The administrator can see the there are many high-scoring vulnerabilities that will require attention right away.
...
program. The Nessus Vulnerability Visualization system makes the most critical and most
severe vulnerabilities most prominent in the visualization. It also makes it easier to view large
